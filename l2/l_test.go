...
func TestNew(t *testing.T) {
	...
	logger := ll.With(String("specific_value", "testing"))
	logger.DebugCtx(ctx, "test request_id", String("message", "test"))
	logger.InfoCtx(ctx, "test request_id", String("message", "test"))
	logger.WarnCtx(ctx, "test request_id", String("message", "test"))
	logger.ErrorCtx(ctx, "test request_id", String("message", "test"))
}
